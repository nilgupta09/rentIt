...
const Contact = () => {
    ...
    return   <section className="py-16 bg-gray-100 font-poppins dark:bg-gray-900">
                ...
                <div className="flex flex-wrap mb-4 -mx-2">
                    <div className="w-full px-2 mb-4 lg:mb-0 lg:w-1/2">
                        <input
                            ...
                            onChange={(e) => setFirstName(e.target.value)} type="text" placeholder="First Name.." required=""/>
                    </div>
                    <div className="w-full px-2 lg:w-1/2">
                        <input
                            className="w-full px-3 py-2 leading-loose border rounded-md bg-gray-50 dark:text-gray-400 dark:bg-gray-700 dark:border-gray-700"
                            onChange={(e) => setLastName(e.target.value)} type="text" placeholder="Last Name.." required=""/>
                    </div>
                </div>
                <input
                    ...
                    onChange={(e) => setEmail(e.target.value)} type="email" placeholder="abc@gmail.com" required=""/>
                <textarea rows="4" type="message" placeholder="Write a message..." required=""
                    onChange={(e) => setMessage(e.target.value)} className="block w-full px-4 mb-4 leading-tight text-gray-700 border rounded bg-gray-50 dark:placeholder-gray-400 py-7 dark:text-gray-400 dark:border-gray-800 dark:bg-gray-700 "></textarea>
                <button
